...
import Resume from "../assets/ziya-resume.pdf";
...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#1b1b1a] text-gray-300'>
      <div>
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#1b1b1a] flex flex-col justify-center items-center"
        }
      >
